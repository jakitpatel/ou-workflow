...
export default function IngredientMgmt({
  ...
  const ingredientData: IngredientRow[] =
    isPrelimApplicationDetail
      ...
      : (application.ingredients as IngredientRow[]) || []
  const filteredIngredients = !isPrelimApplicationDetail && showRecentOnly
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                {isPrelimApplicationDetail ? (
                  <th className="text-left py-3 px-4 text-xs font-semibold text-gray-700 uppercase tracking-wider">UKDID</th>
                ) : null}
                ...
                <th className="text-left py-3 px-4 text-xs font-semibold text-gray-700 uppercase tracking-wider">
                  {isPrelimApplicationDetail ? 'Bulk' : 'GRP'}
                </th>
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {filteredIngredients.length > 0 ? (
                filteredIngredients.map((ingredient, index) => {
                  ...
                  const ukdid = readRecordText(ingredientRecord, ['UKDID', 'ukdid', 'UKD-ID', 'ncrcId'])
                  ...
                  return (
                    ...
                    >
                      {isPrelimApplicationDetail ? (
                        <td className="py-3 px-4 align-top text-gray-700">{displayText(ukdid)}</td>
                      ) : null}
                ...
                <tr>
                  <td colSpan={isPrelimApplicationDetail ? 7 : 7} className="py-12 text-center">
