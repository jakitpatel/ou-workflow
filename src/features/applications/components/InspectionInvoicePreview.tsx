...
export function InspectionInvoicePreview(props: Props) {
  ...
  const handlePrint = () => {
    ...
    doc.open()
    doc.write(
      `<!doctype html><html><head><title>${fileName}</title></head><body style="margin:0">${content}</body></html>`,
    )
    doc.close()
    window.setTimeout(() => {
  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-100 p-5">
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          {invoiceDownloadLink ? (
            ...
            <button
              disabled
              className="rounded border border-slate-300 bg-white px-2.5 py-1 text-xs font-semibold text-slate-400"
            >
              Download PDF
            </button>
          )}
      ...
      <div
        ref={invoiceRef}
        className="relative mx-auto max-w-[760px] overflow-hidden rounded-sm border border-slate-300 bg-white shadow-sm"
      >
        ...
        <article className="ou-invoice">
          <header className="ou-head">
            <div className="ou-mark">
              <div className="ou-circle">U</div>
              <small>
                KOSHER
                <br />
                CERTIFICATION
            ...
            <div className="ou-brand">
              <div className="ou-brand-title">Orthodox Union</div>
              <div className="ou-brand-sub">UNION OF ORTHODOX JEWISH CONGREGATIONS OF AMERICA</div>
              <div className="ou-brand-address">
          ...
          <div className="info-row">
            <div className="bill">
              ...
              <br />
              Attn {customer.billingContactName || 'Accounts Payable'}
            </div>
            <div className="right-info">
              ...
              <div className="pay-box">
                <h4>Online Payments: oudirect.org</h4>
                <div>
                  <strong>Wire/ACH Bank Info:</strong>
                  <br />
                  Bank: JPMorgan Chase Bank
                  <br />
                  Account: Orthodox Union
                  <br />
                  Account #: 1353211
                  <br />
                  ABA #: 021000021
          ...
          <table className="charges">
            ...
            <tbody>
              <tr className="section">
                <td>
                  {isApplicationFeeOnly ? 'Application Fee' : 'Application/Initial Inspection Fee'}
                </td>
                <td>
              ...
              <tr className="detail">
                <td>
                  ...
                  <br />
                  <br />
                  {applicant?.plant || applicant?.company || 'Application'}
                </td>
                <td>
                  <div className="amount-split">
                    <span>{feeAmount > 0 ? formatCurrency(feeAmount) : 'Not selected'}</span>
              ...
              <tr className="total">
                ...
                <td className="total-value">{formatCurrency(total)} USD</td>
              </tr>
            </tbody>
          </table>
          <footer className="footer">
            <div>
              <strong>UNION OF ORTHODOX JEWISH CONGREGATIONS OF AMERICA</strong>40 Rector St., 4th
              Floor, New York, NY 10006
              <br />
              (212) 563-4000 &nbsp; fax (212) 564-9058
            </div>
            <div className="footer-center">Payable in US Dollars</div>
          </footer>
        </article>
      </div>
    </div>
