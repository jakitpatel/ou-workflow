    ...
    <div className="h-full overflow-y-auto bg-slate-100 p-5">
      ...
      <div ref={invoiceRef} className="relative mx-auto max-w-[760px] overflow-hidden rounded-sm border border-slate-300 bg-white shadow-sm">
        ...
        <article className="ou-invoice">
          ...
          <div className="contact-box"><h4>For questions or comments, contact your Rabbinic Coordinator.</h4><div className="contact-grid"><span>{customer.coordinatorName || 'Rabbinic Coordinator'}</span><span>{customer.coordinatorPhone || '(212) 613-8000'}</span><span>{customer.billingContactEmail || 'billing@ou.org'}</span></div></div>
