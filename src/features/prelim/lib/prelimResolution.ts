...
export const countUpdatedCompanyFields = (before: CompanyData, after: CompanyData) => {
  const checks = [
    ...
    hasChanged(before.companyState, after.companyState),
    hasChanged(before.ZipPostalCode, after.ZipPostalCode),
...
export const countUpdatedPlantFields = (before: PlantData, after: PlantData) => {
  const checks = [
    ...
    hasChanged(before.plantState, after.plantState),
    hasChanged(before.plantZip, after.plantZip),
